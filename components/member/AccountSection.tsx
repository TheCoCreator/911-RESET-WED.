    ...
    <div className="max-w-2xl space-y-8 animate-fade-in">
      ...
      <section className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
        ...
        <p className="text-slate-600 text-sm mb-6">
          You are subscribed to the 911 Reset Wednesdays Full Access plan.
        </p>
        ...
        <button 
          ...
          className="flex items-center gap-2 text-teal-700 font-bold hover:text-teal-900 transition-colors"
        >
