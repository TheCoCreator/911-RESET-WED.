  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <header className="bg-white p-8 rounded-xl border border-slate-100 shadow-sm">
        <h1 className="text-3xl font-bold text-slate-900 mb-2">Welcome back to 911 Reset Wednesdays</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {/* Next Live Session */}
        <div className="bg-teal-900 text-white p-6 rounded-xl shadow-md flex flex-col justify-between h-full">
          <div>
            <div className="flex items-center gap-2 mb-4 text-teal-200 uppercase text-xs font-bold tracking-wider">
              <Calendar className="w-4 h-4" />
              Next Live Session
            </div>
            <h3 className="text-xl font-bold mb-2">This Wednesday</h3>
            <p className="text-teal-100">9:00 PM Atlantic Time</p>
          </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200 flex flex-col justify-between h-full">
          ...
          <button 
            ...
            className="mt-6 w-full py-3 border border-slate-200 hover:border-teal-600 hover:text-teal-700 rounded-lg text-sm font-semibold transition-all flex items-center justify-center gap-2"
          >
